...
This will commit to the gh-pages branch on https://github.com/StevenSawtelle/politicle/settings/pages. Then you change
the `Custom domain` section back to `politicle.us`
